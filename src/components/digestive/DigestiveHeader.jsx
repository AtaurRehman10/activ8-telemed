    ...
    <section style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#fff', position: 'relative' }}>
      ...
      <div className="hero-wrapper" style={{
        ...
        >
          ...
          >
            <img src={imgDigestiveHero4} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>

          {/* top-right: taller, spans rows 1-2 */}
          <motion.div
            {...fadeIn(0.4)}
            style={{ borderRadius: 20, overflow: 'hidden', gridColumn: '2', gridRow: '1 /3' }}
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgDigestiveHero5} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
          ...
          <motion.div
            ...
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgDigestiveHero1} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
          ...
          <motion.div
            ...
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgDigestiveHero3} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
          ...
          <motion.div
            ...
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgDigestiveHero2} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
        </motion.div>
      </div>
