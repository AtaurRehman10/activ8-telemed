...
import {
  imgHormonesHero1, imgHormonesHero2, imgHormonesHero3,
  imgHormonesHero4, imgHormonesHero5,
...
export default function HormonesHeader() {
    ...
    <section style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#fff', position: 'relative' }}>
      ...
      <div className="hero-wrapper" style={{
        ...
        <div className="hero-left" style={{ flex: '1 1 50%', minWidth: 0, display: 'flex', flexDirection: 'column', gap: 15, alignSelf: 'center' }}>
          ...
          >
            Stop Blaming Your Age Start Optimizing Your Hormones
          </motion.h1>
          ...
          >
            Fatigue, low drive, unexplained weight gain, and brain fog aren&apos;t just &quot;getting older.&quot; They&apos;re signs of hormone imbalance — and they&apos;re treatable with the right provider.
          </motion.p>
        ...
        >
          ...
          >
            <img src={imgHormonesHero4} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>

          {/* top-right, spans rows 1-2 */}
          <motion.div
            {...fadeIn(0.4)}
            style={{ borderRadius: 20, overflow: 'hidden', gridColumn: '2', gridRow: '1 / 3' }}
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgHormonesHero5} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
          ...
          <motion.div
            ...
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgHormonesHero1} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
          ...
          <motion.div
            ...
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgHormonesHero3} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
          ...
          <motion.div
            ...
            className="transition-all duration-500 hover:scale-105"
          >
            <img src={imgHormonesHero2} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </motion.div>
        </motion.div>
      </div>
